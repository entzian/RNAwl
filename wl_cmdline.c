...
const char  *gengetopt_args_info_purpose =
  "Sample the Density of States by a Wang-Landau MC simulation";

const char  *gengetopt_args_info_usage =
  "Usage: " CMDLINE_PARSER_PACKAGE " [OPTIONS]... [FILES]...";
...
cmdline_parser_print_version(void)
{
  printf("%s %s\n",
         (strlen(
            CMDLINE_PARSER_PACKAGE_NAME) ? CMDLINE_PARSER_PACKAGE_NAME : CMDLINE_PARSER_PACKAGE),
...
int
cmdline_parser_dump(FILE                        *outfile,
                    struct gengetopt_args_info  *args_info)
{
  int i = 0;
           ...
           const char               *additional_error)
{
  ...
  switch (arg_type) {
    ...
    case ARG_FLOAT:
      if (val)
        *((float *)field) = (float)strtod(val, &stop_char);
    ...
    case ARG_LONGLONG:
      ...
      if (val)
        *((long long int *)field) = (long long int)strtol(val, &stop_char, 0);
